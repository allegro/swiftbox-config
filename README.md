...
[![Build Status](https://travis-ci.org/allegro/swiftbox-config.svg?branch=master)](https://travis-ci.org/allegro/swiftbox-config)
...
SwiftBox Configuration allows to pass type-safe configuration such as 
command line, environment variables and external providers (e.g Vault) 
by declaring one simple struct.
Configuration can be inherited from multiple sources simultaneously.
